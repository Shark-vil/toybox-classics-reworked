...
function SWEP:Initialize()
  if CLIENT then
    self.RocketEntity = ClientsideModel("models/Weapons/W_missile_closed.mdl", RENDERGROUP_OPAQUE)
  end
...
function SWEP:OnRemove()
  if CLIENT and self.RocketEntity then
    self.RocketEntity:Remove()
  end
end
...
function SWEP:PrimaryAttack()
  ...
  if SERVER then
    ...
    if self:GetOwner():EyeAngles().p > 45 then
      time = 0.25
    end
